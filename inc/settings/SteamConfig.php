...
$steamauth['loginpage'] = "settings.php#steam"; // Page to redirect to after a successfull login (from the directory the SteamAuth-folder is located in) - NO slash at the beginning!
