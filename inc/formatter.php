...
elseif ($rank == "19") {
    ...
    $ranktext2 = "Platinum I";
}
elseif ($rank == "18") {
    $ranktext = "Platinum<br>II";
    $ranktext2 = "Platinum II";
}
elseif ($rank == "17") {
    $ranktext = "Platinum<br>III";
    $ranktext2 = "Platinum III";
}
elseif ($rank == "16") {
    $ranktext = "Gold<br>I";
    $ranktext2 = "Gold I";
...
elseif ($rank == "0") {
    ...
    $ranktext = "Rank not shown or hasn't been set.";
    $ranktext2 = "Rank not shown or hasn't been set.";
}
?>
